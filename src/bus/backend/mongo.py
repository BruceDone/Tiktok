...
class MongoBackend(BaseBackend):
    ...
    def __init__(self, host, port, db, dagobah_collection='dagobah',
        ...
        self.log_coll.ensure_index("job_id")
        self.log_coll.ensure_index("log_id")
    ...
    def commit_dagobah(self, dagobah_json):
        ...
        dagobah_json['save_date'] = datetime.utcnow()
        self.dagobah_coll.save(dict(dagobah_json))
    ...
    def commit_job(self, job_json):
        ...
        job_json['save_date'] = datetime.utcnow()
        self.job_coll.save(dict(job_json))
