...
class BaseBackend(object):
    ...
    def get_dagobah(self):
        raise NotImplementedError

    def add_dagobah(self, dagobah_id):
        raise NotImplementedError
    ...
    def mongo_to_dict(self, mongo_model):
        if not mongo_model:
            raise ValueError('you pass the empty mongo model')

        json_str = json.dumps(mongo_model, cls=StrictJSONEncoder)
